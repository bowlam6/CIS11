...
CALCULATE_MAX
    LD R1, NUM_TESTS        ; Load the number of tests
...
JSR CLEAR_REG               ; Call subroutine to clear registers R1-R6
LD R4, DECODE_DEC           ; Load the value for decoding ASCII digits
...
BREAK_INT
ST R7, SAVELOC1             ; Save the return address
LD R5, DECODE_SYM           ; Load the value for encoding digits as ASCII
